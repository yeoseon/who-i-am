...
2. 업무 수행시 **'이 작업을 왜 수행하는지', '이 작업을 위한 모든 기술을 100% 알고 있는지', '더 좋은 방법은 없는 지'** 등을 항상 고민하는 
...
* 현재 구직중이며, 이런 조직에서 일하고 싶습니다.  
   * 좋은 소프트웨어와 개발자의 성장을 위한 문화가 있거나 만들어가고 있는 (코드리뷰, 테스트 주도 개발 등..)
   * 공유/세미나가 활발하고 소통이 자유로운  
   * 신뢰를 바탕으로 업무가 자율적으로 이루어지는
