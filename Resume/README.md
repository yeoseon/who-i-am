...
`#스프링` `#Backend개발자로전환` `#회사문화개선` `#기준/표준과일관성` `#체계적인업무프로세스` `#클린코드` `#테스트` `#개발자의성장` `#노션없으면못사는` `#매일공부하는` `#Frontend에도관심이많은`  
...
**projects** | CBP 5.x (금융 솔루션)

### [맑은기술](http://www.malgn.com/)  
**기간** | 2016.03 - 2019.01 (2년 10개월)  
**포지션** | 웹 프론트엔드 개발자 (서비스, 화면 개발)  
**projects** | mConverter (비디오 컨버팅 관리 서비스), [한국여자농구연맹(WKBL)의 영상 콘텐츠 제공 웹 서비스](http://datalab.wkbl.or.kr/gameinfo?id=03901001), KeyFlow ADAMS (Content Management System), 한국여자농구연맹(WKBL) 스포츠 아카이브 솔루션 (관리자 웹 서비스), KeyFlow Enterprise 3.x (Media Assert Management)
...
* 개발 4년차 부족함을 느끼고 공부에 집중  
* 매일 사용하는 Java와 Springboot도 다시 공부

## About 다양한 기술  

* 서비스 End to End 경험을 하고 싶어 시작한 사이드 프로젝트  
* Frontend Framework에도 관심이 많음  

## About Making  

* 서비스를 직접 만들어 배포해보고 싶은 마음으로 개인 사이드 프로젝트 진행  
...
* [Junior 개발자를 위한 클린코드를 공부하며 배운 것들]() (2020.07)  
  개발자로서 어떤 공부를 하며 성장해야할 지 고민했던 시기에 `클린코드`를 공부하게 되며 배운 것들을 공유한 내용입니다.   
   
## Activity  

이 Resume은 **2020.10.02**에 업데이트 되었습니다.
