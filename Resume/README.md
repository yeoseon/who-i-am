...
이 기간의 업무 수행을 통해 좋은 API를 디자인하기 위한 방법, 명확한 기준을 기반으로 하여 타당한 근거를 통해 동료와 소통하는 방법에 대한 관심이 많아졌습니다.  

개인적으로는 Clean Code에 대한 큰 관심을 가지고 업무와 병행하여 공부하고 있으며, 제품의 성능과 코드 스타일을 개선할 계획을 가지고 있습니다.  
...
**사용기술: Spring Framework(Spring Boot), AngularJS(JavaScript), bootstrap, Mybatis, PostgreSQL, MySQL**
...
* **Git** - 필요성을 느끼고 사이드 프로젝트를 통해 적극적으로 사용하고 있습니다. Git의 원리를 이해하고 사용하려고 노력하고 있습니다.  
...
* **IntelliJ** - 업무, 사이드 프로젝트를 통해 적극적으로 도입하여 사용하고 있습니다.  
